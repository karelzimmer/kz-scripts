...
# -----------------------------------------------------------------------------
REBOOT=true
if grep --quiet debian /etc/os-release; then sudo apt-get remove --purge --assume-yes broadcom-sta-dkms; fi
if grep --quiet rhel   /etc/os-release; then echo 'The broadcom-sta-dkms app is not available.'; fi
...
if grep --quiet debian /etc/os-release && [[ -n ${DISPLAY-} ]]; then sudo usermod --append --groups libvirt,libvirt-qemu "${SUDO_USER:-$USER}"; fi
# -----------------------------------------------------------------------------
...
if grep --quiet debian /etc/os-release && [[ -n ${DISPLAY-} ]]; then sudo gpasswd --delete "${SUDO_USER:-$USER}" libvirt; fi
if grep --quiet debian /etc/os-release && [[ -n ${DISPLAY-} ]]; then sudo gpasswd --delete "${SUDO_USER:-$USER}" libvirt-qemu; fi
if grep --quiet debian /etc/os-release && [[ -n ${DISPLAY-} ]]; then sudo groupdel libvirt; fi
if grep --quiet debian /etc/os-release && [[ -n ${DISPLAY-} ]]; then sudo groupdel libvirt-qemu; fi
...
# BitTorrent client.
# -----------------------------------------------------------------------------
if grep --quiet debian /etc/os-release; then sudo apt-get remove --purge --assume-yes transmission; fi
