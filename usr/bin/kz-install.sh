...
if $GUI && $APT ; then sudo apt-get install --assume-yes cockpit cockpit-pcp ; fi
...
if $GUI && $APT ; then sudo apt-get install --assume-yes libimage-exiftool-perl ; fi
...
if $GUI && $APT ; then sudo apt-get install --assume-yes gnome-gmail ; fi
...
if $GUI && $APT ; then sudo delgroup libvirtd-dnsmasq ; fi
if $GUI && $APT ; then sudo deluser karel libvirtd ; fi
if $GUI && $APT ; then sudo deluser karel libvirtd-qemu ; fi
if $GUI && $APT ; then sudo delgroup libvirtd ; fi
...
# Download videos.
if $GUI && $APT ; then sudo apt-get install --assume-yes youtubedl-gui ; fi
if $GUI && $RPM ; then sudo dnf install --assumeyes youtube-dl ; fi

# Remove youtube-dl from pc-van-emily pc-van-hugo
# Download videos.
if $GUI && $APT ; then sudo apt-get remove --purge --assume-yes youtubedl-gui ; fi
