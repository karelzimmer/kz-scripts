...
if $DESKTOP_ENVIRONMENT && $DEB && $GNOME; then sudo apt-get install --assume-yes chrome-gnome-shell; fi
# Import GPG Key.
...
if $DESKTOP_ENVIRONMENT && $DEB && $GNOME; then apt-get remove --assume-yes chrome-gnome-shell; fi
