...
! type gnome-session &> /dev/null || sudo apt-get install --yes gnome-shell-extension-dashtodock

# Remove dashtodock from *
! type gnome-session &> /dev/null || sudo apt-get remove --yes gnome-shell-extension-dashtodock
