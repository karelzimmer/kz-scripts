...
if type gnome-session; then gsettings reset org.gnome.shell.extensions.dash-to-dock disable-overview-on-startup || true; fi # Not every GNOME machine has this key.
