...
if type gnome-session &> /dev/null; then gsettings set org.gnome.shell.extensions.dash-to-dock disable-overview-on-startup true; fi
...
if type gnome-session &> /dev/null; then gsettings reset org.gnome.shell.extensions.dash-to-dock disable-overview-on-startup; fi
...
# Reset gnome for *
if type gnome-session &> /dev/null; then gsettings reset org.gnome.desktop.app-folders folder-children; fi
