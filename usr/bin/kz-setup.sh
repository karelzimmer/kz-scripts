...
if type lxqt-session &> /dev/null; then sed --in-place --expression='/\[mainmenu\]\|\[fancymenu\]/a categoriesAtRight=false' ~/.config/lxqt/panel.conf; fi
#
LOGOUT=true
...
if type lxqt-session &> /dev/null; then sed --in-place --expression='/single_click_activate=/d' ~/.config/lxqt/lxqt.conf; fi
if type lxqt-session &> /dev/null; then sed --in-place --expression='/\[General\]/a single_click_activate=false' ~/.config/lxqt/lxqt.conf; fi
if type lxqt-session &> /dev/null; then sed --in-place --expression='/categoriesAtRight=/d' ~/.config/lxqt/panel.conf; fi
if type lxqt-session &> /dev/null; then sed --in-place --expression='/\[mainmenu\]\|\[fancymenu\]/a categoriesAtRight=true' ~/.config/lxqt/panel.conf; fi
#
LOGOUT=true
