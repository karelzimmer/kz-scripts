...
# Setup gnome on *
# Desktop environment.
if $GUI && apt-cache show org.gnome.desktop.calendar &> /dev/null ; then gsettings set org.gnome.desktop.calendar show-weekdate true ; fi
if $GUI && apt-cache show org.gnome.desktop.interface &> /dev/null ; then gsettings set org.gnome.desktop.interface clock-show-date true ; fi
if $GUI && apt-cache show org.gnome.desktop.interface &> /dev/null ; then gsettings set org.gnome.desktop.interface clock-show-weekday true ; fi
if $GUI && apt-cache show org.gnome.desktop.interface &> /dev/null ; then gsettings set org.gnome.desktop.interface show-battery-percentage true ; fi
if $GUI && apt-cache show org.gnome.desktop.peripherals.touchpad &> /dev/null ; then gsettings set org.gnome.desktop.peripherals.touchpad tap-to-click true ; fi
if $GUI && apt-cache show org.gnome.desktop.screensaver &> /dev/null ; then gsettings set org.gnome.desktop.screensaver lock-enabled false ; fi
if $GUI && apt-cache show org.gnome.desktop.session &> /dev/null ; then gsettings set org.gnome.desktop.session idle-delay 900 ; fi
if $GUI && apt-cache show org.gnome.desktop.sound &> /dev/null ; then gsettings set org.gnome.desktop.sound allow-volume-above-100-percent true ; fi
if $GUI && apt-cache show org.gnome.desktop.wm.preferences &> /dev/null ; then gsettings set org.gnome.desktop.wm.preferences button-layout :minimize,maximize,close ; fi
if $GUI && apt-cache show org.gnome.mutter &> /dev/null ; then gsettings set org.gnome.mutter center-new-windows true ; fi
if $GUI && apt-cache show org.gnome.nautilus.icon-view &> /dev/null ; then gsettings set org.gnome.nautilus.icon-view default-zoom-level large ; fi
if $GUI && apt-cache show org.gnome.nautilus.preferences &> /dev/null ; then gsettings set org.gnome.nautilus.preferences click-policy single ; fi
if $GUI && apt-cache show org.gnome.nautilus.preferences &> /dev/null ; then gsettings set org.gnome.nautilus.preferences open-folder-on-dnd-hover true ; fi
if $GUI && apt-cache show org.gnome.nautilus.preferences &> /dev/null ; then gsettings set org.gnome.nautilus.preferences show-create-link true ; fi
if $GUI && apt-cache show org.gnome.nautilus.preferences &> /dev/null ; then gsettings set org.gnome.nautilus.preferences show-image-thumbnails always ; fi
if $GUI && apt-cache show org.gnome.settings-daemon.plugins.power &> /dev/null ; then gsettings set org.gnome.settings-daemon.plugins.power power-button-action interactive ; fi
if $GUI && apt-cache show org.gnome.settings-daemon.plugins.power &> /dev/null ; then gsettings set org.gnome.settings-daemon.plugins.power sleep-inactive-ac-type nothing ; fi
if $GUI && apt-cache show org.gnome.settings-daemon.plugins.power &> /dev/null ; then gsettings set org.gnome.settings-daemon.plugins.power sleep-inactive-battery-type nothing ; fi

# Reset gnome on *
# Desktop environment.
if $GUI && apt-cache show org.gnome.desktop.calendar &> /dev/null ; then gsettings reset org.gnome.desktop.calendar show-weekdate ; fi
if $GUI && apt-cache show org.gnome.desktop.interface &> /dev/null ; then gsettings reset org.gnome.desktop.interface clock-show-date ; fi
if $GUI && apt-cache show org.gnome.desktop.interface &> /dev/null ; then gsettings reset org.gnome.desktop.interface clock-show-weekday ; fi
if $GUI && apt-cache show org.gnome.desktop.interface &> /dev/null ; then gsettings reset org.gnome.desktop.interface show-battery-percentage ; fi
if $GUI && apt-cache show org.gnome.desktop.peripherals.touchpad &> /dev/null ; then gsettings reset org.gnome.desktop.peripherals.touchpad tap-to-click ; fi
if $GUI && apt-cache show org.gnome.desktop.screensaver &> /dev/null ; then gsettings reset org.gnome.desktop.screensaver lock-enabled ; fi
if $GUI && apt-cache show org.gnome.desktop.session &> /dev/null ; then gsettings reset org.gnome.desktop.session idle-delay ; fi
if $GUI && apt-cache show org.gnome.desktop.sound &> /dev/null ; then gsettings reset org.gnome.desktop.sound allow-volume-above-100-percent ; fi
if $GUI && apt-cache show org.gnome.desktop.wm.preferences &> /dev/null ; then gsettings reset org.gnome.desktop.wm.preferences button-layout ; fi
if $GUI && apt-cache show org.gnome.mutter &> /dev/null ; then gsettings reset org.gnome.mutter center-new-windows ; fi
if $GUI && apt-cache show org.gnome.nautilus.icon-view &> /dev/null ; then gsettings reset org.gnome.nautilus.icon-view default-zoom-level ; fi
if $GUI && apt-cache show org.gnome.nautilus.preferences &> /dev/null ; then gsettings reset org.gnome.nautilus.preferences click-policy ; fi
if $GUI && apt-cache show org.gnome.nautilus.preferences &> /dev/null ; then gsettings reset org.gnome.nautilus.preferences open-folder-on-dnd-hover ; fi
if $GUI && apt-cache show org.gnome.nautilus.preferences &> /dev/null ; then gsettings reset org.gnome.nautilus.preferences show-create-link ; fi
if $GUI && apt-cache show org.gnome.nautilus.preferences &> /dev/null ; then gsettings reset org.gnome.nautilus.preferences show-image-thumbnails ; fi
if $GUI && apt-cache show org.gnome.settings-daemon.plugins.power &> /dev/null ; then gsettings reset org.gnome.settings-daemon.plugins.power power-button-action ; fi
if $GUI && apt-cache show org.gnome.settings-daemon.plugins.power &> /dev/null ; then gsettings reset org.gnome.settings-daemon.plugins.power sleep-inactive-ac-type ; fi
if $GUI && apt-cache show org.gnome.settings-daemon.plugins.power &> /dev/null ; then gsettings reset org.gnome.settings-daemon.plugins.power sleep-inactive-battery-type ; fi
