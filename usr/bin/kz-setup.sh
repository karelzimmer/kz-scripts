...
# -----------------------------------------------------------------------------
if type gnome-session; then ~/.local/bin/gext install   'CoverflowAltTab@palatis.blogspot.com'; fi
if type gnome-session; then ~/.local/bin/gext enable    'CoverflowAltTab@palatis.blogspot.com'; fi
# -----------------------------------------------------------------------------
# Compiz windows effect
# https://extensions.gnome.org/extension/3210/compiz-windows-effect/
# -----------------------------------------------------------------------------
if type gnome-session; then ~/.local/bin/gext install   'compiz-windows-effect@hermes83.github.com'; fi
if type gnome-session; then ~/.local/bin/gext enable    'compiz-windows-effect@hermes83.github.com'; fi
# -----------------------------------------------------------------------------
# Compiz alike magic lamp effect
# https://extensions.gnome.org/extension/3740/compiz-alike-magic-lamp-effect/
# -----------------------------------------------------------------------------
if type gnome-session; then ~/.local/bin/gext install   'compiz-alike-magic-lamp-effect@hermes83.github.com'; fi
if type gnome-session; then ~/.local/bin/gext enable    'compiz-alike-magic-lamp-effect@hermes83.github.com'; fi
# -----------------------------------------------------------------------------
# Customize Clock on Lock Screen
# https://extensions.gnome.org/extension/4663/customize-clock-on-lock-screen/
# -----------------------------------------------------------------------------
if type gnome-session; then ~/.local/bin/gext install   'CustomizeClockOnLockScreen@pratap.fastmail.fm'; fi
if type gnome-session; then ~/.local/bin/gext enable    'CustomizeClockOnLockScreen@pratap.fastmail.fm'; fi
# -----------------------------------------------------------------------------
# Desktop Cube
# https://extensions.gnome.org/extension/4648/desktop-cube/
# -----------------------------------------------------------------------------
if type gnome-session; then ~/.local/bin/gext install   'desktop-cube@schneegans.github.com'; fi
if type gnome-session; then ~/.local/bin/gext enable    'desktop-cube@schneegans.github.com'; fi
...
# https://extensions.gnome.org/extension/97/coverflow-alt-tab/
# -----------------------------------------------------------------------------
if type gnome-session; then ~/.local/bin/gext disable   'CoverflowAltTab@palatis.blogspot.com'; fi
if type gnome-session; then ~/.local/bin/gext uninstall 'CoverflowAltTab@palatis.blogspot.com'; fi
# -----------------------------------------------------------------------------
# Compiz windows effect
# https://extensions.gnome.org/extension/3210/compiz-windows-effect/
# -----------------------------------------------------------------------------
if type gnome-session; then ~/.local/bin/gext disable   'compiz-windows-effect@hermes83.github.com'; fi
if type gnome-session; then ~/.local/bin/gext uninstall 'compiz-windows-effect@hermes83.github.com'; fi
# -----------------------------------------------------------------------------
# Compiz alike magic lamp effect
# https://extensions.gnome.org/extension/3740/compiz-alike-magic-lamp-effect/
# -----------------------------------------------------------------------------
if type gnome-session; then ~/.local/bin/gext disable   'compiz-alike-magic-lamp-effect@hermes83.github.com'; fi
if type gnome-session; then ~/.local/bin/gext uninstall 'compiz-alike-magic-lamp-effect@hermes83.github.com'; fi
# -----------------------------------------------------------------------------
# Customize Clock on Lock Screen
# https://extensions.gnome.org/extension/4663/customize-clock-on-lock-screen/
# -----------------------------------------------------------------------------
if type gnome-session; then ~/.local/bin/gext disable   'CustomizeClockOnLockScreen@pratap.fastmail.fm'; fi
if type gnome-session; then ~/.local/bin/gext uninstall 'CustomizeClockOnLockScreen@pratap.fastmail.fm'; fi
# -----------------------------------------------------------------------------
# Desktop Cube
# https://extensions.gnome.org/extension/4648/desktop-cube/
# -----------------------------------------------------------------------------
