...
if [[ $HOSTNAME = pc07 && $USER = karel ]]; then kzgset --removefav --file='firefox-esr.desktop'; fi
if [[ $HOSTNAME = pc07 && $USER = karel ]]; then kzgset --removefav --file='org.gnome.Evolution.desktop'; fi
