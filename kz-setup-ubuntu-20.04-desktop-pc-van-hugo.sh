...
kz-gset --addfavend='telegram-desktop_telegram-desktop.desktop'
#3 Start Terminalvenster en voer uit:
#3    kz-gset --removefav='telegram-desktop_telegram-desktop.desktop'

#1 virtualbox (virtualisatie)
kz-gset --addfavend='virtualbox.desktop'
...
kz-gset --addfavend='kz-vm-hugowin732.desktop'
...
#3    kz-gset --removefav='virtualbox.desktop'
#3    kz-gset --removefav='kz-vm-hugowin732.desktop'
