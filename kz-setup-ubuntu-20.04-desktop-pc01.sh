...
if [[ $HOSTNAME = pc01 && $USER = karel ]]; then kzgset --addfavtop --file='org.gnome.gedit.desktop'; fi
...
if [[ $HOSTNAME = pc01 && $USER = monique ]]; then kzgset --addfavtop --file='gnome-gmail.desktop'; fi
#4 Start Terminalvenster en voer uit:
#4    kzgset --removefav --file='gnome-gmail.desktop'
...
if [[ $HOSTNAME = pc01 && ($USER = karel || $USER = monique) ]]; then kzgset --removefav --file='firefox.desktop'; fi
...
#1
#2 Python instellen
if [[ $HOSTNAME = pc01 && $USER = karel ]]; then kzgset --addfavtop --file='idle.desktop'; fi
#4 Start Terminalvenster en voer uit:
...
if [[ $HOSTNAME = pc01 && $USER = karel ]]; then kzgset --addfavtop --file='org.gnome.Terminal.desktop'; fi
#4 Start Terminalvenster en voer uit:
...
if [[ $HOSTNAME = pc01 && $USER = monique ]]; then kzgset --addfavtop --file='kz-zga-ehrm.desktop'; fi
#4 Start Terminalvenster en voer uit:
#4    rm "$HOME"/.local/share/applications/kz-zga-ehrm.desktop
#4    kzgset --removefav --file='kz-zga-ehrm.desktop'
...
if [[ $HOSTNAME = pc01 && $USER = monique ]]; then kzgset --addfavtop --file='kz-zga-intranet.desktop'; fi
#4 Start Terminalvenster en voer uit:
#4    rm "$HOME"/.local/share/applications/kz-zga-intranet.desktop
#4    kzgset --removefav --file='kz-zga-intranet.desktop'
...
if [[ $HOSTNAME = pc01 && $USER = monique ]]; then kzgset --addfavtop --file='kz-zga-monaco.desktop'; fi
#4 Start Terminalvenster en voer uit:
#4    rm "$HOME"/.local/share/applications/kz-zga-monaco.desktop
#4    kzgset --removefav --file='kz-zga-monaco.desktop'
...
if [[ $HOSTNAME = pc01 && $USER = monique ]]; then kzgset --addfavtop --file='kz-zga-webmail.desktop'; fi
#4 Start Terminalvenster en voer uit:
#4    rm "$HOME"/.local/share/applications/kz-zga-webmail.desktop
#4    kzgset --removefav --file='kz-zga-webmail.desktop'
